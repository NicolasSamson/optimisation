...
df = pd.read_csv(r"C:\Users\Proprio\OneDrive - Université Laval\École\A 2022\Investigation\optimisation_2\test_folder\Tangram_G_Code_Solved\result_time\result_time_500_photo_2.csv")
...
print("ratio de solution trouvée sur pas trouvée not inplace",len(indice_simul_not_in_place)/500)
list_diff_temp = []
list_temp_inplace = []
